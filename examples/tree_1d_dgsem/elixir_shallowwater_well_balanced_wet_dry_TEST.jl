...
#
# DO NOT DELETE: Used for visualisation of problem when HR used without modified alpha for shock capturing
# Put dispatched method in "indicators_1d.jl" into comments do deactivate new alpha (hard coded 1 for "dry")
#
...
basis = LobattoLegendreBasis(6)#3)
